...
import { makeSquiggleDefinitions as makeRelativeValuesSquiggleDefinitions, library as relativeValuesLibrary, } from "../../fr/relativeValues.js";
...
export function makeSquiggleBindings(builtins) {
    let squiggleBindings = ImmutableMap();
    for (const makeDefinitions of [makeRelativeValuesSquiggleDefinitions]) {
        ...
        for (const definition of squiggleDefinitions) {
            squiggleBindings = squiggleBindings.set(definition.name, definition.value);
        }
    }

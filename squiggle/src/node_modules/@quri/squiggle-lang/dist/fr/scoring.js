...
export const library = [
    maker.make({
        ...
        definitions: [
            makeDefinition([
                frDict(["estimate", frDist], ["answer", frDistOrNumber], ["prior", frDist]),
            ...
            makeDefinition([frDict(["estimate", frDist], ["answer", frDistOrNumber])], ([{ estimate, answer }], context) => {
                if (answer instanceof BaseDist) {
    ...
    maker.make({
        ...
        definitions: [
            makeDefinition([frDist, frDist], ([estimate, d], context) => runScoringDistAnswer(estimate, d, undefined, context.environment)),
        ],
    }),
];

  ...
  switch (t1.TAG | 0) {
    ...
    case /* Discrete */1 :
        ...
        switch (t2.TAG | 0) {
          ...
          case /* Continuous */2 :
              return Curry._1(Continuous$QuriSquiggleLang.T.toPointSetDist, Continuous$QuriSquiggleLang.combineAlgebraicallyWithDiscrete(op, t2._0, m1, /* First */0));
    ...
    case /* Continuous */2 :
        ...
        switch (t2.TAG | 0) {
          case /* Mixed */0 :
              break;
          case /* Discrete */1 :
              return Curry._1(Continuous$QuriSquiggleLang.T.toPointSetDist, Continuous$QuriSquiggleLang.combineAlgebraicallyWithDiscrete(op, m1$1, t2._0, /* Second */1));
          case /* Continuous */2 :
...
function toSparkline(t, bucketCount) {
  return E_R$QuriSquiggleLang.fmap(E_O$QuriSquiggleLang.toResult(E_O$QuriSquiggleLang.fmap(Curry._1(T.toContinuous, t), (function (param) {
                      ...
                      })), /* CannotSparklineDiscrete */0), (function (r) {

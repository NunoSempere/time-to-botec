...
function firstAtOrBeforeXValue(t, xValue) {
  ...
  var previousIndex = firstIndex !== undefined ? (
      firstIndex !== 0 ? firstIndex - 1 | 0 : undefined
    ) : E_A$QuriSquiggleLang.length(zipped) - 1 | 0;
...
var combine = (// This function combines two xyShapes by looping through both of them simultaneously.

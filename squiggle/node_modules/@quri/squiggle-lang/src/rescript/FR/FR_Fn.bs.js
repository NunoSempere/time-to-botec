...
var library = [FunctionRegistry_Core$QuriSquiggleLang.$$Function.make("declare", nameSpace, true, [FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make("declare", [frType], (function (inputs, param, param$1) {
              ...
              }), undefined)], ["Function.declare({\n  fn: {|a,b| a },\n  inputs: [\n    {min: 0, max: 100},\n    {min: 30, max: 50}\n  ]\n})"], /* EvtDeclaration */3, "Adds metadata to a function of the input ranges. Works now for numeric and date inputs. This is useful when making predictions. It allows you to limit the domain that your prediction will be used and scored within.", true, undefined)];

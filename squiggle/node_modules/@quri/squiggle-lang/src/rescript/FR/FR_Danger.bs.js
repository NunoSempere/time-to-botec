...
var laplace$1 = FunctionRegistry_Core$QuriSquiggleLang.$$Function.make("laplace", nameSpace, true, [Curry._2(FunctionRegistry_Helpers$QuriSquiggleLang.DefineFn.Numbers.twoToOne, "laplace", laplace)], ["Danger.laplace(1, 20)"], /* EvtNumber */6, undefined, undefined, undefined);

var factorial$1 = FunctionRegistry_Core$QuriSquiggleLang.$$Function.make("factorial", nameSpace, true, [Curry._2(FunctionRegistry_Helpers$QuriSquiggleLang.DefineFn.Numbers.oneToOne, "factorial", factorial)], ["Danger.factorial(20)"], /* EvtNumber */6, undefined, undefined, undefined);

var choose$1 = FunctionRegistry_Core$QuriSquiggleLang.$$Function.make("choose", nameSpace, true, [Curry._2(FunctionRegistry_Helpers$QuriSquiggleLang.DefineFn.Numbers.twoToOne, "choose", choose)], ["Danger.choose(1, 20)"], /* EvtNumber */6, undefined, undefined, undefined);

var binomial$1 = FunctionRegistry_Core$QuriSquiggleLang.$$Function.make("binomial", nameSpace, true, [Curry._2(FunctionRegistry_Helpers$QuriSquiggleLang.DefineFn.Numbers.threeToOne, "binomial", binomial)], ["Danger.binomial(1, 20, 0.5)"], /* EvtNumber */6, undefined, undefined, undefined);
...
function integrateFunctionBetweenWithNumIntegrationPoints(aLambda, min, max, numIntegrationPoints, context, reducer) {
  var applyFunctionAtFloatToFloatOption = function (point) {
    ...
    if (typeof resultAsInternalExpression === "number" || resultAsInternalExpression.TAG !== /* IEvNumber */6) {
      return {
              TAG: 1,
              _0: {
                TAG: 15,
...
var integrateFunctionBetweenWithNumIntegrationPoints$1 = FunctionRegistry_Core$QuriSquiggleLang.$$Function.make("integrateFunctionBetweenWithNumIntegrationPoints", nameSpace, false, [FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make("integrateFunctionBetweenWithNumIntegrationPoints", [
            ...
            }), undefined)], ["Danger.integrateFunctionBetweenWithNumIntegrationPoints({|x| x+1}, 1, 10, 10)"], /* EvtNumber */6, undefined, undefined, undefined);
...
var integrateFunctionBetweenWithEpsilon = FunctionRegistry_Core$QuriSquiggleLang.$$Function.make("integrateFunctionBetweenWithEpsilon", nameSpace, false, [FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make("integrateFunctionBetweenWithEpsilon", [
            ...
            }), undefined)], ["Danger.integrateFunctionBetweenWithEpsilon({|x| x+1}, 1, 10, 0.1)"], /* EvtNumber */6, undefined, undefined, undefined);
...
function optimalAllocationGivenDiminishingMarginalReturnsForManyFunctions(lambdas, funds, approximateIncrement, context, reducer) {
  ...
  var optimalAllocationEndAccumulator = E_A$QuriSquiggleLang.reduce(arrayOfIncrements, initAccumulator, (function (acc, newIncrement) {
          ...
          if (oldMarginalReturnsWrapped.TAG !== /* Ok */0) {
            return {
                    TAG: 1,
          ...
          if (newMarginalResultsLambdai.TAG === /* Ok */0) {
  ...
  if (optimalAllocationEndAccumulator.TAG === /* Ok */0) {
    return {
            TAG: 0,
...
var optimalAllocationGivenDiminishingMarginalReturnsForManyFunctions$1 = FunctionRegistry_Core$QuriSquiggleLang.$$Function.make("optimalAllocationGivenDiminishingMarginalReturnsForManyFunctions", nameSpace, false, [FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make("optimalAllocationGivenDiminishingMarginalReturnsForManyFunctions", [
            ...
            /* FRTypeNumber */0
              ...
              if (innerlambdas.TAG !== /* IEvArray */0) {
                return {
                        TAG: 1,
                        _0: {
                          TAG: 15,
              ...
              if (approximateIncrement.TAG !== /* IEvNumber */6) {
                return {
                        TAG: 1,
                        _0: {
                          TAG: 15,
              ...
              var individuallyWrappedLambdas = E_A$QuriSquiggleLang.fmap(innerlambdas._0, (function (innerLambda) {
                      if (typeof innerLambda === "number" || innerLambda.TAG !== /* IEvLambda */5) {
                        return {
                                TAG: 1,
                                _0: {
                                  TAG: 15,
            ...
            }), undefined)], ["Danger.optimalAllocationGivenDiminishingMarginalReturnsForManyFunctions([{|x| x+1}, {|y| 10}], 100, 0.01)"], /* EvtArray */0, undefined, undefined, undefined);

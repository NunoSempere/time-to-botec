...
function fnMake(name, examples, definitions) {
  return FunctionRegistry_Core$QuriSquiggleLang.$$Function.make(name, nameSpace, false, definitions, examples, /* EvtDistribution */4, undefined, undefined, undefined);
}
...
function make$1(name, fn) {
  return FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make(name, [/* FRTypeDistOrNumber */5], (function (inputs, context, param) {

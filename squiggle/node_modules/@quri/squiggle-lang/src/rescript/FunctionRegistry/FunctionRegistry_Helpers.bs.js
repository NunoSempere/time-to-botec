...
function openA(inputs) {
  if (typeof inputs === "number" || inputs.TAG !== /* IEvArray */0) {
    return {
            TAG: 1,
            _0: impossibleErrorString,
            [Symbol.for("name")]: "Error"
...
function twoDist(values) {
  ...
  var a2 = values[1];
  if (typeof a2 === "number" || a2.TAG !== /* IEvDistribution */4) {
    return {
            TAG: 1,
            _0: impossibleErrorString,
            [Symbol.for("name")]: "Error"
...
function twoNumbers(values) {
  ...
  var a2 = values[1];
  if (typeof a2 === "number" || a2.TAG !== /* IEvNumber */6) {
    return {
            TAG: 1,
            _0: impossibleErrorString,
            [Symbol.for("name")]: "Error"
...
function threeNumbers(values) {
  ...
  var a3 = values[2];
  if (typeof a3 === "number" || a3.TAG !== /* IEvNumber */6) {
    return {
            TAG: 1,
            _0: impossibleErrorString,
            [Symbol.for("name")]: "Error"
...
function oneNumber(value) {
  if (typeof value === "number" || value.TAG !== /* IEvNumber */6) {
    return {
            TAG: 1,
            _0: impossibleErrorString,
            [Symbol.for("name")]: "Error"
...
function oneDict(value) {
  if (typeof value === "number" || value.TAG !== /* IEvRecord */7) {
    return {
            TAG: 1,
            _0: impossibleErrorString,
            [Symbol.for("name")]: "Error"
...
function twoValues(fn, values, env) {
  var a1 = values[0];
  if (a1.TAG === /* FRValueNumber */0) {
    var a2 = values[1];
    var a1$1 = a1._0;
    if (a2.TAG === /* FRValueNumber */0) {
      return Curry._1(fn, [
                  a1$1,
                  a2._0
                ]);
...
function oneToOne(name, fn) {
  return FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make(name, [/* FRTypeNumber */0], (function (inputs, param, param$1) {
                if (inputs.length !== 1) {
                  return {
                          TAG: 1,
                          _0: impossibleError,
...
function twoToOne(name, fn) {
  return FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make(name, [
              ...
              /* FRTypeNumber */0
                ...
                var y = inputs[1];
                if (typeof y === "number" || y.TAG !== /* IEvNumber */6) {
                  return {
                          TAG: 1,
                          _0: impossibleError,
                          [Symbol.for("name")]: "Error"
...
function threeToOne(name, fn) {
  return FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make(name, [
              ...
              /* FRTypeNumber */0
                ...
                var z = inputs[2];
                if (typeof z === "number" || z.TAG !== /* IEvNumber */6) {
                  return {
                          TAG: 1,
                          _0: impossibleError,
                          [Symbol.for("name")]: "Error"
...
function f2f(name, fn, nameSpaceOpt, requiresNamespaceOpt, examples, param) {
  ...
  return FunctionRegistry_Core$QuriSquiggleLang.$$Function.make(name, nameSpace, requiresNamespace, [FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make(name, [/* FRTypeNumber */0], (function (inputs, param, param$1) {
                      if (inputs.length !== 1) {
                        return {
                                TAG: 1,
                                _0: impossibleError,
                    ...
                    }), undefined)], E_O$QuriSquiggleLang.$$default(examples, []), /* EvtNumber */6, undefined, undefined, undefined);
}
...
function ff2b(name, fn, nameSpaceOpt, requiresNamespaceOpt, examples, param) {
  ...
  return FunctionRegistry_Core$QuriSquiggleLang.$$Function.make(name, nameSpace, requiresNamespace, [FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make(name, [
                    ...
                    }), undefined)], E_O$QuriSquiggleLang.$$default(examples, []), /* EvtBool */1, undefined, undefined, undefined);
}
...
function bb2b(name, fn, nameSpaceOpt, requiresNamespaceOpt, examples, param) {
  ...
  return FunctionRegistry_Core$QuriSquiggleLang.$$Function.make(name, nameSpace, requiresNamespace, [FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make(name, [
                    ...
                    /* FRTypeBool */1
                      ...
                      var y = inputs[1];
                      if (typeof y === "number" || y.TAG !== /* IEvBool */1) {
                        return {
                                TAG: 1,
                                _0: impossibleError,
                                [Symbol.for("name")]: "Error"

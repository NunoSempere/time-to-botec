...
function toString(t) {
  if (typeof t === "number") {
    switch (t) {
      ...
      case /* FRTypeBool */1 :
          return "bool";
      case /* FRTypeNumeric */2 :
          return "numeric";
      case /* FRTypeDate */3 :
          return "date";
      case /* FRTypeTimeDuration */4 :
          return "duration";
      case /* FRTypeDistOrNumber */5 :
...
function matchWithValue(t, r) {
  if (typeof t === "number") {
    switch (t) {
      case /* FRTypeNumber */0 :
          if (typeof r === "number" || r.TAG !== /* IEvNumber */6) {
            return false;
          } else {
            return true;
          }
      case /* FRTypeBool */1 :
          if (typeof r === "number" || r.TAG !== /* IEvBool */1) {
            return false;
          } else {
            return true;
          }
      ...
      case /* FRTypeDate */3 :
          if (typeof r === "number" || r.TAG !== /* IEvDate */2) {
            return false;
          } else {
            return true;
          }
      case /* FRTypeTimeDuration */4 :
          if (typeof r === "number" || r.TAG !== /* IEvTimeDuration */9) {
            return false;
          } else {
            return true;
          }
      ...
      case /* FRTypeDist */6 :
          if (typeof r === "number" || r.TAG !== /* IEvDistribution */4) {
            return false;
          } else {
            return true;
          }
      case /* FRTypeLambda */7 :
          if (typeof r === "number" || r.TAG !== /* IEvLambda */5) {
            return false;
          } else {
            return true;
          }
      case /* FRTypeString */8 :
          if (typeof r === "number" || r.TAG !== /* IEvString */8) {
            return false;
          } else {
            return true;
          }

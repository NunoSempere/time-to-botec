...
function toDistR(t) {
    if (t.TAG === 0) {
        ...
        return {
            TAG: 1,
            _0: E_O$QuriSquiggleLang.$$default(toError(t), 1),
...
function run(env, functionCallInfo) {
    ...
    var toPointSetFn = function (r) {
        ...
        if (e.TAG !== 0) {
            return {
                TAG: 1,
                _0: E_O$QuriSquiggleLang.$$default(toError(e), 1),
                [Symbol.for("name")]: "Error"
            };
        }
        var p = e._0;
...
function fmap(env, input, functionCallInfo) {
    ...
    if (exit === 1) {
        newFnCall = functionCallInfo.TAG === 0 ? ({
            TAG: 1,
            _0: {
                TAG: 7,
...
//# sourceMappingURL=DistributionOperation.bs.js.map
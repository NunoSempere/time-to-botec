...
function firstErrorOrOpen(results) {
    ...
    var bringErrorUp = match !== undefined && match.TAG !== 0 ? ({
        TAG: 1,
        _0: match._0,
        [Symbol.for("name")]: "Error"
    }) : ({
...
var $$RangeError = Caml_exceptions.create("E_A-QuriSquiggleLang.Floats.RangeError");
...
//# sourceMappingURL=E_A.bs.js.map
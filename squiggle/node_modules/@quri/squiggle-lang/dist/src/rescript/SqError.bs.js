...
var MessageException = Caml_exceptions.create("SqError-QuriSquiggleLang.Message.MessageException");
...
var SqException = Caml_exceptions.create("SqError-QuriSquiggleLang.SqException");
...
function toStringWithStackTrace(t) {
    return toString(t.message) + (Reducer_FrameStack$QuriSquiggleLang.isEmpty(t.frameStack) ? "\nStack trace:\n" + Reducer_FrameStack$QuriSquiggleLang.toString(t.frameStack) : "");
}
function $$throw$1(t) {
    throw {
...
//# sourceMappingURL=SqError.bs.js.map
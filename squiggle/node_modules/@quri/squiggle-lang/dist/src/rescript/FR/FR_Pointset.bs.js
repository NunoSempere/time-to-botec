    ...
    if (typeof items === "number" || items.TAG !== 0) {
        ...
        return E_R$QuriSquiggleLang.fmap(E_R$QuriSquiggleLang.bind({
            ...
            _0: E_A$QuriSquiggleLang.fmap(items._0, (function (item) {
                ...
                if (xValue !== undefined && !(typeof xValue === "number" || !(xValue.TAG === 6 && yValue !== undefined && !(typeof yValue === "number" || yValue.TAG !== 6)))) {
                    return [
                        xValue._0,
                        yValue._0
                    ];
...
var library = [
    FunctionRegistry_Core$QuriSquiggleLang.$$Function.make("fromDist", nameSpace, true, [FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make("fromDist", [6], (function (inputs, context, param) {
        ...
        }), undefined)], ["PointSet.fromDist(normal(5,2))"], 4, undefined, undefined, undefined),
    FunctionRegistry_Core$QuriSquiggleLang.$$Function.make("mapY", nameSpace, true, [FunctionRegistry_Core$QuriSquiggleLang.FnDefinition.make("mapY", [
        ...
        }), undefined)], ["PointSet.mapY(mx(normal(5,2)), {|x| x + 1})"], 4, undefined, undefined, undefined),
...
//# sourceMappingURL=FR_Pointset.bs.js.map
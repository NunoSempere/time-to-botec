...
function catchAndConvertTwoArgsToDists(args) {
    ...
    switch (a.TAG | 0) {
        ...
        case 6:
            var b$1 = args[1];
            if (typeof b$1 === "number" || b$1.TAG !== 4) {
                return;
            }
            else {
                return [
...
function dispatchToGenericOutput(call, env) {
    ...
    switch (fnName) {
        case "cdf":
            ...
            var $$float = args[1];
            if (typeof $$float === "number" || $$float.TAG !== 6) {
                return;
            }
            else {
                return toFloatFn({
        ...
        case "dotExp":
            ...
            var a = args[0];
            if (typeof a === "number" || a.TAG !== 4) {
                return;
            }
            else {
                return twoDiststoDistFn(0, "dotPow", GenericDist$QuriSquiggleLang.fromFloat(MagicNumbers$QuriSquiggleLang.$$Math.e), a._0, env);
            }
        case "dotAdd":
        case "dotDivide":
        case "dotMultiply":
        ...
        case "exp":
            ...
            var a$1 = args[0];
            if (typeof a$1 === "number" || a$1.TAG !== 4) {
                return;
            }
            else {
        ...
        case "inspect":
            ...
            var dist$1 = args[0];
            if (typeof dist$1 === "number" || dist$1.TAG !== 4) {
                return;
            }
            else {
                return toDistFn(2, dist$1._0, env);
            }
        case "integralSum":
            if (args.length !== 1) {
                return;
            ...
            var dist$2 = args[0];
            if (typeof dist$2 === "number" || dist$2.TAG !== 4) {
                return;
            }
            else {
        ...
        case "inv":
            ...
            var $$float$1 = args[1];
            if (typeof $$float$1 === "number" || $$float$1.TAG !== 6) {
                return;
            }
            else {
                return toFloatFn({
        ...
        case "isNormalized":
            ...
            var dist$4 = args[0];
            if (typeof dist$4 === "number" || dist$4.TAG !== 4) {
                return;
            }
            else {
                return toBoolFn(0, dist$4._0, env);
            }
        case "log":
            if (args.length !== 1) {
                exit = 2;
        ...
        case "log10":
            ...
            var a$3 = args[0];
            if (typeof a$3 === "number" || a$3.TAG !== 4) {
                return;
            }
            else {
                return twoDiststoDistFn({
        ...
        case "normalize":
            ...
            var dist$5 = args[0];
            if (typeof dist$5 === "number" || dist$5.TAG !== 4) {
                return;
            }
            else {
                return toDistFn(0, dist$5._0, env);
            }
        case "pdf":
            if (args.length !== 2) {
                return;
            ...
            var $$float$2 = args[1];
            if (typeof $$float$2 === "number" || $$float$2.TAG !== 6) {
                return;
            }
            else {
                return toFloatFn({
        ...
        case "quantile":
            ...
            var $$float$3 = args[1];
            if (typeof $$float$3 === "number" || $$float$3.TAG !== 6) {
                return;
            }
            else {
                return toFloatFn({
        ...
        case "sample":
            ...
            var dist$8 = args[0];
            if (typeof dist$8 === "number" || dist$8.TAG !== 4) {
                return;
            }
            else {
        ...
        case "scaleExp":
            ...
            var dist$10 = args[0];
            if (typeof dist$10 === "number" || dist$10.TAG !== 4) {
                return;
            }
            else {
                return toDistFn({
        ...
        case "scaleLog":
            ...
            switch (len) {
                ...
                case 1:
                    var dist$11 = args[0];
                    if (typeof dist$11 === "number" || dist$11.TAG !== 4) {
                        return;
                    }
                    else {
                        return toDistFn({
                ...
                case 2:
                    ...
                    var $$float$4 = args[1];
                    if (typeof $$float$4 === "number" || $$float$4.TAG !== 6) {
                        return;
                    }
                    else {
                        return toDistFn({
        ...
        case "scaleLog10":
            ...
            var dist$13 = args[0];
            if (typeof dist$13 === "number" || dist$13.TAG !== 4) {
                return;
            }
            else {
                return toDistFn({
        ...
        case "scaleLogWithThreshold":
            ...
            var eps = args[2];
            if (typeof eps === "number" || eps.TAG !== 6) {
                return;
            }
            else {
                return toDistFn({
        ...
        case "scaleMultiply":
            ...
            var $$float$5 = args[1];
            if (typeof $$float$5 === "number" || $$float$5.TAG !== 6) {
                return;
            }
            else {
                return toDistFn({
        ...
        case "scalePow":
            ...
            var $$float$6 = args[1];
            if (typeof $$float$6 === "number" || $$float$6.TAG !== 6) {
                return;
            }
            else {
                return toDistFn({
        ...
        case "sparkline":
            ...
            switch (len$1) {
                ...
                case 1:
                    var dist$17 = args[0];
                    if (typeof dist$17 === "number" || dist$17.TAG !== 4) {
                        return;
                    }
                    else {
                        return toStringFn({
                ...
                case 2:
                    ...
                    var n$1 = args[1];
                    if (typeof n$1 === "number" || n$1.TAG !== 6) {
                        return;
                    }
                    else {
                        return toStringFn({
        ...
        case "toPointSet":
            ...
            var dist$19 = args[0];
            if (typeof dist$19 === "number" || dist$19.TAG !== 4) {
                return;
            }
            else {
                return toDistFn(1, dist$19._0, env);
            }
        case "toString":
            if (args.length !== 1) {
                return;
            ...
            var dist$20 = args[0];
            if (typeof dist$20 === "number" || dist$20.TAG !== 4) {
                return;
            }
            else {
                return toStringFn(0, dist$20._0, env);
            }
        case "triangular":
            if (args.length !== 3) {
                return;
        ...
        case "truncate":
            ...
            var float2 = args[2];
            if (typeof float2 === "number" || float2.TAG !== 6) {
                return;
            }
            else {
                return toDistFn({
        ...
        case "truncateLeft":
            ...
            var $$float$7 = args[1];
            if (typeof $$float$7 === "number" || $$float$7.TAG !== 6) {
                return;
            }
            else {
                return toDistFn({
        ...
        case "truncateRight":
            ...
            var $$float$8 = args[1];
            if (typeof $$float$8 === "number" || $$float$8.TAG !== 6) {
                return;
            }
            else {
                return toDistFn({
        ...
        case "unaryMinus":
            ...
            var a$4 = args[0];
            if (typeof a$4 === "number" || a$4.TAG !== 4) {
                return;
            }
            else {
                return twoDiststoDistFn({
    ...
    switch (exit) {
        ...
        case 3:
            if (args.length !== 2) {
                ...
                return E_O$QuriSquiggleLang.fmap(catchAndConvertTwoArgsToDists(args), (function (param) {
                    return twoDiststoDistFn(0, fnName, param[0], param[1], env);
                }));
            }
    }
}
...
var library = E_A$QuriSquiggleLang.concatMany([
    [
        ...
        makeProxyFn("mean", [6]),
        makeProxyFn("stdev", [6]),
        makeProxyFn("variance", [6]),
        makeProxyFn("min", [6]),
        makeProxyFn("max", [6]),
        makeProxyFn("mode", [6]),
        makeProxyFn("integralSum", [6]),
        makeProxyFn("toString", [6]),
        makeProxyFn("sparkline", [6]),
        makeProxyFn("sparkline", [
            6,
            0
        ]),
        makeProxyFn("exp", [6]),
        makeProxyFn("normalize", [6]),
        makeProxyFn("isNormalized", [6]),
        makeProxyFn("toPointSet", [6]),
        makeProxyFn("scaleLog", [6]),
        makeProxyFn("scaleLog10", [6]),
        ...
        makeProxyFn("log", [6]),
        makeProxyFn("log10", [6]),
        makeProxyFn("unaryMinus", [6]),
        makeProxyFn("dotExp", [6])
    ],
...
//# sourceMappingURL=FR_GenericDist.bs.js.map
...
var library = [
    ...
    makeFn("inspect", [9], (function (inputs) {
        if (inputs.length !== 1) {
            return {
                TAG: 1,
                _0: FunctionRegistry_Helpers$QuriSquiggleLang.impossibleError,
    ...
    makeFn("javascriptraise", [9], (function (inputs) {
        if (inputs.length !== 1) {
            return {
                TAG: 1,
                _0: FunctionRegistry_Helpers$QuriSquiggleLang.impossibleError,
...
//# sourceMappingURL=FR_Builtin.bs.js.map